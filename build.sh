...
products/osnastka/screws/index.html|screws|screws|Шнеки поділу потоку для ліній розливу — Sofon|Виготовляємо шнеки поділу потоку під вашу тару й ваше обладнання: складна геометрія, ділянки зупинки й уповільнення, здвоєні. Матеріал — під умови ділянки, відтворення зношеного за зразком.
